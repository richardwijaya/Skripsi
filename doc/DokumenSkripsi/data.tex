...
%=============================================================================
\namanpm{Richard Wijaya}{2016730014}
\tanggal{2}{2}{2021}
\pembimbing{\PAN}{}    
\penguji{\CHW}{\NAT} 
%=============================================================================
...
%=============================================================================
\judulINA{{\it Virtual Jogging App} untuk Google Cardboard}
\judulENG{Virtual Jogging App for Google Cardboard}
%_____________________________________________________________________________
%=============================================================================
% 								BAGIAN X
%=============================================================================
...
% - langsung mulai setelah '{' awal, jangan mulai menulis di baris bawahnya
%=============================================================================
\abstrakINA{Olahraga menjadi salah satu kebutuhan manusia, tetapi banyak orang memiliki kendala seperti rasa malas dan jenuh. Rasa malas dan jenuh ini bahkan membuat orang tidak melakukan aktivitas olahraga paling sederhana, yaitu berlari. Jika ada aplikasi yang dapat membawa pemandangan di luar ke dalam ruangan selama berlari, banyak orang dapat ingin melakukannya karena lebih terasa lebih menyenangkan.

Untuk menampilkan suatu dunia di tepat di depan mata, \textit{Google VR} dan \textit{Google Cardboard} dapat dimanfaatkan. Untuk mendapatkan gambar pemandangan di luar, \textit{Google StreetView API} digunakan untuk memperoleh gambar lokasi tertentu. Rute perjalanan dari pelari diperoleh dari \textit{Google Directions API}, lalu perubahan pemandangan diatur oleh sensor gerak, sesuai dengan langkah kaki pengguna. Dengan menyatukan semuanya, aplikasi dapat membawa lingkungan lari yang ada di luar ruangan ke dalam ruangan.
...
\abstrakENG{Exercising has been a need of a human being, people finds that monotonous and people are lazy doing it. The laziness and the monotnous feeling prevents people from doing even the simplest form of exercise, which is jogging. If an mobile application can bring the outdoor environment while running indoor, a lot of people may be encouraged to exercise because if feels fun.
...
% Petunjuk: hilangkan tanda << & >>, dan isi sesuai dengan data anda.
%=============================================================================
\kunciINA{Google VR, \textit{Google Cardboard}, \textit{Google StreetView API}, \textit{Google Directions API}, sensor \textit{step detector}}
\kunciENG{Google VR, Google Cardboard, Google StreetView API, Google Directions API, step detector sensor}
%=============================================================================
...
% Petunjuk: hilangkan tanda << & >>, dan isi sesuai dengan data anda.
%=============================================================================
\untuk{Teknik Informatika UNPAR}
%=============================================================================
...
% Petunjuk: hilangkan tanda << & >>, dan isi sesuai dengan data anda.
%=============================================================================
\prakata{Puji syukur kepada Tuhan Yang Maha Esa karena telah memberikan anugerah dan berkat-Nya kepada penulis untuk menyelesaikan skripsi dengan judul \textbf{\textit{Virtual Jogging App} untuk Google Cardboard} dengan cukup baik. Penulis berterimakasih kepada pihak-pihak yang mendukung dan membantu agar skripsi dapat diselesaikan, di antaranya:
	\begin{enumerate}
		\item Keluarga yang mendoakan dan mendukung penulis secara jasmani dan rohani.
		
		\item Bapak Pascal Alfadian selaku dosen pembimbing yang telah membimbing penulis sampai penulis menyelesaikan skripsi ini. 
		
		\item Bapak Chandra Wijaya dan Ibu Natalia selaku tim penguji yang telah membantu menguji dan memperbaiki skripsi ini.
		
		\item Teman-teman Teknik Informatika UNPAR angkatan 2016 yang telah belajar dan berbagi kepada penulis.
		
		\item Pihak-pihak lain yang belum disebutkan, yang membantu penulis menyelesaikan skripsi ini.
	\end{enumerate}
