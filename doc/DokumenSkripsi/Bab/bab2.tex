...
\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{itemize}
			...
			\textit{Array} dari objek \textit{step}, bagian dari \textit{legs}. Beberapa atribut yang dimiliki objek \textit{step} adalah:
				\begin{itemize}
					\item \textit{distance}
					
					Jarak dari\textit{step} ini.
					\item \textit{duration}
					
					Lama waktu yang digunakan untuk menempuh \textit{step} ini.
					\item \textit{start\_location}
					
					Koordinat garis lintang dan bujur dari titik awal \textit{step} ini.
					\item \textit{end\_location}
					
					Koordinat garis lintang dan bujur dari titik akhir \textit{step} ini.
					
					\item \textit{polyline}
					
					Deretan titik di dalam \textit{steps} yang direpresentasikan dengan kumpulan karakter. 
					\item \textit{travel\_mode} 
					
					\textit{Mode} perjalanan yang ditempuh 
